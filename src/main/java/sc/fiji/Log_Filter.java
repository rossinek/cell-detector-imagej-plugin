...
@Plugin(type = Command.class, menuPath = "Developement>LoG filter")
public class Log_Filter implements Command {
  @Parameter
        ...
        for (a0 = 0; a0 < rect.width; a0++) {
          ...
          for (int j = 1; j < (fsize + 1) / 2; j++) {
            ...
            for (i = 1; i < (fsize + 1) / 2; i++) {
              ...
              h12 += logaus[i] * (image[a0d0] + image[a0d1] + image[a1d0] + image[a1d1]);
              h21 += gaus[i] * (image[a0d0] + image[a0d1] + image[a1d0] + image[a1d1]);
            }
            a0d0 = acr - j + dow * size;
            a0d1 = acr + (dow - j) * size;
            a1d0 = acr + j + dow * size;
            ...
            h1h2 += gaus[j] * (h12 + image[a0d0] + image[a0d1] + image[a1d0] + image[a1d1]);
            h2h1 += logaus[j] * (h21 + image[a0d0] + image[a0d1] + image[a1d0] + image[a1d1]);
